...
namespace FabledCervidae
{
    ...
    public static class Patches
    {
        ...
        static Patches()
        {
            ...
            harmony.Patch(original: AccessTools.Method(typeof(Pawn_RelationsTracker), "RelationsTrackerTickInterval"),
                postfix: new HarmonyMethod(typeof(Patches), nameof(RelationsTrackerTickInterval_Postfix)));
        ...
        private static void RelationsTrackerTickInterval_Postfix(Pawn ___pawn)
        {
